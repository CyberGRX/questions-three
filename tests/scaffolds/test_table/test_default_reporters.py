...
from questions_three.scaffolds.common.activate_reporters import \
    BUILT_IN_REPORTERS
# We expect this import to activate the reporters
import questions_three.scaffolds.test_table  # noqa: F401

ACTIVE_REPORTERS = set([
    type(subscriber.__self__)
    for subscriber in EventBroker.get_subscribers()
    ])
