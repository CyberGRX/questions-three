...
class TestDefaultsCascade(TestCase):
    ...
    def test_uses_parent_value_when_child_has_none(self):
        ...
        expect(config_for_module(child_name)[key]).to(equal(value))
    ...
    def test_parent_overrides_grandparent(self):
        ...
        self.add_module(child_name, {})
        expect(config_for_module(child_name)[key]).to(equal(parent_value))
    ...
    def test_child_overrides_parent(self):
        ...
        expect(config_for_module(child_name)[key]).to(equal(child_value))
    ...
    def test_override_is_case_insensitive(self):
        ...
        expect(config_for_module(child_name)[parent_key]).to(equal(child_value))
