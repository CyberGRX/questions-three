...
class TestLaunchBrowserStack(TestCase):
    ...
    def test_uses_configured_browserstack_url(self):
        ...
        actual = urlunsplit((scheme, without_credentials, path, query, fragment))
